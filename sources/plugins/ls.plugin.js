...
class Plugin {
    ...
    static Platform = class {
        static get SingleCore() {
            return "SingleCore";
        }
        static get MultiCore() {
            return "MultiCore";
        }
    };
    ...
    static Category = class {
        ...
        static get Native() {
            return "Native";
        } // Import from native LetSynchronise JSON files
        static get Tool1() {
            return "Tool1";
        } // Import from Tool1 generated files

        // Exporter
        static get LetSynchronise() {
            return "LetSynchronise";
        } // Export to a LetSynchronise JSON file
        static get External() {
            return "External";
        ...
        static get Timing() {
            return "Timing";
        } // Metric for a timing property
        static get Utility() {
            return "Utility";
        } // Metric for a utility property

        // Scheduler
        static get Preemptive() {
            return "Preemptive";
        } // Preemptive scheduling policy
        static get NonPreemptive() {
    ...
    static OfTypeAndCategory(type, category) {
        return Object.fromEntries(
            Object.entries(this.Plugins[type]).filter(
                ([name, plugin]) => plugin.Category == category
            )
        );
    }
    ...
    static OfOutput(plugins, output) {
        return Object.fromEntries(
            Object.entries(plugins).filter(
                ([name, plugin]) => plugin.Output == output
            )
        );
    }
    ...
    static CreateTaskInstances(taskParameters, makespan, executionTiming) {
        return this.ModelSchedule.createTaskInstances(
            taskParameters,
            makespan,
            executionTiming
        );
    ...
    static CreateAllTaskInstances(makespan, executionTiming) {
        return this.ModelSchedule.createAllTaskInstances(
            makespan,
            executionTiming
        );
    }
